...
function start() {
    ...
    im.getClient().sendPacket(Packages.tools.packet.MaplePacketCreator.serverNotice(5, "The Golden Compass is temporarily unable to specify its orientation, Please try again later."));
    im.dispose();
}
