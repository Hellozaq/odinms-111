...
function start() {
    if (im.getPlayer().getMap().getId() != 922030011) {
        im.getClient().sendPacket(Packages.tools.packet.MaplePacketCreator.serverNotice(5, "Your mission is to leave this Black Pouch at the entrance of the First Safe. Go to Sky Terrace and look for the First Safe."));
        im.dispose();
        return;
    }
