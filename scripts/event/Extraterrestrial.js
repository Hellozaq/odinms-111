...
function monsterValue(eim, mobId) { //殺怪後觸發
    if (mobId == 9400802) {
        eim.getMapInstance(610040400).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "葛拉特鑽孔機被打敗了"));
        eim.getMapInstance(610040400).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("quest/party/clear", 3));
        eim.getMapInstance(610040400).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("Party1/Clear", 4));
