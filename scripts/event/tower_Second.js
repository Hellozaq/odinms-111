...
function monsterValue(eim, mobId) { //殺怪後觸發
    if (mobId == 8210011) {
        ...
        eim.getMapInstance(211060401).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("quest/party/clear", 3));
        eim.getMapInstance(211060401).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("Party1/Clear", 4));
        eim.getMapInstance(211060401).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "解开了第二座塔的封印"));
