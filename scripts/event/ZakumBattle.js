...
function monsterValue(eim, mobId) { //殺怪後觸發
    ...
    if (mobId == 8800002) {
        eim.getMapInstance(280030000).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "殘暴炎魔被打敗了"));
        eim.getMapInstance(280030000).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("quest/party/clear", 3));
        eim.getMapInstance(280030000).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("Party1/Clear", 4));
