...
function monsterValue(eim, mobId) { //殺怪後觸發
    if ((mobId == 9300108 || mobId == 9300109 || mobId == 9300110 || mobId == 9300111) && eim.getMapInstance(925100000).getAllMonstersThreadsafe().size() < 1 && eim.getProperty("stage0") == null) {
        eim.getMapInstance(925100000).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "通往下一區域的入口已經開啟"));
    ...
    if ((mobId == 9300124 || mobId == 9300125) && eim.getMapInstance(925100300).getAllMonstersThreadsafe().size() < 1 && eim.getProperty("stage3") == null) {
        eim.getMapInstance(925100300).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "通往下一區域的入口已經開啟"));
    ...
    if ((mobId == 9300112 || mobId == 9300113) && eim.getMapInstance(925100301).getAllMonstersThreadsafe().size() < 1 && eim.getProperty("stage3a") == null) {
        eim.getMapInstance(925100301).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "海賊王的秘密寶箱被你發現了，鑰匙也許在附近區域的海盜王身上"));
    ...
    if ((mobId == 9300124 || mobId == 9300125) && eim.getMapInstance(925100200).getAllMonstersThreadsafe().size() < 1 && eim.getProperty("stage2") == null) {
        eim.getMapInstance(925100200).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "通往下一區域的入口已經開啟"));
    ...
    if ((mobId == 9300112 || mobId == 9300113) && eim.getMapInstance(925100201).getAllMonstersThreadsafe().size() < 1 && eim.getProperty("stage2a") == null) {
        eim.getMapInstance(925100201).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "海賊王的秘密寶箱被你發現了，鑰匙也許在附近區域的海盜王身上"));
    ...
    if (mobId == 9300119 || mobId == 9300105 || mobId == 9300106) {
        ...
        eim.getMapInstance(925100500).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "海賊王被消滅，雨揚被釋放"));
