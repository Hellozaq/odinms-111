...
function monsterValue(eim, mobId) { //殺怪後觸發
    ...
    if (mobId == 8850011) {
        ...
        eim.getMapInstance(271040100).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "西格諾斯被打敗了"));
        eim.getMapInstance(271040100).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("quest/party/clear", 3));
        eim.getMapInstance(271040100).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("Party1/Clear", 4));
    }
    return 1;
}
