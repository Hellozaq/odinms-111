...
function monsterValue(eim, mobId) { //殺怪後觸發
    if (mobId == 8840000) {
        eim.getMapInstance(211070100).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "凡雷恩被打敗了"));
        eim.getMapInstance(211070100).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("quest/party/clear", 3));
        eim.getMapInstance(211070100).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("Party1/Clear", 4));
