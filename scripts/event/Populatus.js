...
function monsterValue(eim, mobId) { //殺怪後觸發
    if (mobId == 8500002) {
        eim.getMapInstance(220080001).broadcastMessage(Packages.tools.packet.MaplePacketCreator.serverNotice(6, "拉圖斯被打敗了"));
        eim.getMapInstance(220080001).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("quest/party/clear", 3));
        eim.getMapInstance(220080001).broadcastMessage(Packages.tools.packet.EtcPacket.environmentChange("Party1/Clear", 4));
