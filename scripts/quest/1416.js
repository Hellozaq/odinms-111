...
function start(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            qm.sendNext("你想選擇冰雷巫師嗎？冰雷巫師是因為主要使用冰屬性和電屬性的攻擊魔法，囙此被稱為冰雷巫師。");
            break;
        case 1:
            qm.sendNextPrev("冰雷巫師能使用的技能，包括熟悉魔法的咒語精通，吸收敵人魔量的魔力吸收，提高隊員魔力的精神強化，還有使智力得到提高的#b#q2200007##k等等。");
            break;
        case 2:
            qm.sendNextPrev("我只是作了簡要的說明，你想成為冰雷巫師嗎？那樣的話，你必須通過簡單的測試才行。只要進入準備好的試驗場，消滅怪物，收集#b30#k個黑暗之珠就行。");
            break;
        case 3:
...
function end(mode, type, selection) {
    ...
    switch (status) {
        ...
        case 1:
            ...
            qm.sendNext("從現在開始，你就是冰雷巫師了……巫師是以較高的智力為基礎，使用自然力量壓制敵人的人……希望你一定要努力新增學識…..");
            break;
        case 2:
