...
function start(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            qm.sendNext("你想成為真正的獵人嗎？獵人是在弓和弩當中使用#b弓的職業#k，因為弓箭的速度較快，動作敏捷，可以連續射箭，擊退敵人。");
            break;
        case 1:
            qm.sendNextPrev("獵人能使用的技能，包括熟悉武器的精準之弓，提高攻擊速度的快速之弓，造成強力傷害的炸彈箭，還有提升機動性的#b#q3101003##k等等。");
            break;
        case 2:
            qm.sendNextPrev("我只是作了簡要的說明，你想成為獵人嗎？那樣的話，你必須通過簡單的測試才行。只要進入準備好的試驗場，消滅怪物，收集#b30#k個黑暗之珠就行。");
            break;
        case 3:
