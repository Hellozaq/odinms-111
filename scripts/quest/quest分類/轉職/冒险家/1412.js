...
function start(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            qm.sendNext("你想選擇見習騎士之路嗎？見習騎士是擁有各種不同屬性魔法的劍士，主要使用的武器是#b劍#k和#b棍#k。");
            break;
        case 1:
            qm.sendNextPrev("見習騎士能使用的技能，包括熟悉武器的武器精通，提高攻擊速度的極速武器，壓制敵人屬性的降魔咒，還有吸收反射敵人傷害的#b#q1201007##k等等。");
            break;
        case 2:
            qm.sendNextPrev("我只是作了簡要的說明，你想成為見習騎士嗎？那樣的話，你必須通過簡單的測試才行。只要進入準備好的試驗場，消滅怪物，收集#b30#k個黑暗之珠就行。");
            break;
        case 3:
...
function end(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            qm.sendYesNo("我果然沒有看錯人，我知道你一定可以做到，你展現出了沉著和勇敢……讓我來把你引上見習騎士之路，準備好了嗎？");
            break;
        case 1:
            Packages.server.quest.MapleQuest.getInstance(1412).forceComplete(qm.getPlayer(), qm.getNpc());
            qm.getPlayer().changeJob(120);
            qm.removeAll(4031013);
            qm.sendNext("從現在起你就是見習騎士了，見習騎士是對敵人冷靜，對隊友負有獻身精神，是具有騎士道的劍士。希望你能憑藉自己明亮的雙眼，走上正確的道路。");
            break;
        case 2:
