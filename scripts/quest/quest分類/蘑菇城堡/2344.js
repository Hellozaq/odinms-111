...
function start(mode, type, selection) {
    ...
    switch (status) {
        ...
        case 5:
            qm.dispose();
            Packages.server.quest.MapleQuest.getInstance(2344).forceStart(qm.getPlayer(), qm.getNpc(), null);
...
function end(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            qm.sendNext("嗯？#v4032375#！！！什麼，你是…警衛兵麥克推薦你來的？");
            break;
        case 1:
            qm.sendNextPrevS("是…這樣啊。");
            break;
        case 2:
            qm.sendPrev("嗯……我瞭解了，既然麥克都認可了，那一定就是勇士了。很抱歉我沒有自我介紹，我是菇菇王國的警衛隊長，正如你所看到的，這裡是我們暫時的藏身之地，我們的情況很糟糕，儘管如此，#b歡迎你來到菇菇王國#k。");
            break;
        case 3:
            Packages.server.quest.MapleQuest.getInstance(2344).forceComplete(qm.getPlayer(), qm.getNpc());
