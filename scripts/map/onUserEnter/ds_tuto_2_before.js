...
function action(mode, type, selection) {
    ...
    switch (status) {
        case 0:
            ...
            ms.getClient().sendPacket(Packages.tools.packet.EtcPacket.environmentChange("demonSlayer/text13", 3));
            ms.getClient().sendPacket(Packages.tools.packet.EtcPacket.UIPacket.getDirectionInfo(1, 1000));
            break;
        case 1:
            ms.getClient().sendPacket(Packages.tools.packet.EtcPacket.environmentChange("demonSlayer/text14", 3));
