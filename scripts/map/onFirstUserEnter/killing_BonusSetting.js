...
function start() {
    ...
    ms.getClient().sendPacket(Packages.tools.packet.EtcPacket.environmentChange("killing/bonus/bonus", 3));
    ms.getClient().sendPacket(Packages.tools.packet.EtcPacket.environmentChange("killing/bonus/stage", 3));
