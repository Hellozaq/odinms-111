...
public class BattleConstants {
    ...
    public static enum PokemonMap { // eh?...=.=
        ...
        MAP1(180000001, 1, 4, 2, new Point(20, 35), new Point(320, 35));
    ...
    public static enum PokemonMob {
        ...
        Road_Auf(PokemonItem.Cold_Heart, MobExp.IMPOSSIBLE, PokemonAbility.Immunity, PokemonAbility.MarvelScale, 7120109, 8220011, 9400289),
