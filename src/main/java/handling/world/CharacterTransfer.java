...
public class CharacterTransfer implements Externalizable {
    ...
    public long lastfametime, TranferTime, plusMeso, pcdate, chairp;
    ...
    public CharacterTransfer(final MapleCharacter chr) {
        ...
        this.plusMeso = chr.getPMeso();
        this.chairp = chr.getChairP();
    ...
    public void readExternal(final ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        this.plusMeso = in.readLong();
        this.chairp = in.readLong();
    ...
    public void writeExternal(final ObjectOutput out) throws IOException {
        ...
        out.writeLong(this.plusMeso);
        out.writeLong(this.chairp);
