    ...
    public static final void handlePacket(final RecvPacketOpcode header, final LittleEndianAccessor slea, final MapleClient c, final boolean cs) throws Exception {
        switch (header) {
            ...
            case CLIENT_ERROR:
                ...
                slea.skip(4); // ?				
                FileoutputUtil.log("logs/ErrorCodes.rtf", "Client sent crashing packet: Type: " + type_str + "; Error code: " + unk + "; Length: " + data_length + "; Packet: " + slea.toString());
                break;
            ...
            case SET_GENDER:
                ...
                break;
            case ACCEPT_TOS:    
                AcceptToSHandler handler = new AcceptToSHandler();
                handler.TOS(slea, c);
            default:
