...
public class StatsHandling {
    ...
    public static final void DistributeSP(final int skillid, final MapleClient c, final MapleCharacter chr) {
        ...
        if (chr.isGM()) {
            chr.dropMessage(5, "[系統提示]您已經與技能" + skillid + " 的連接");
        }
        ...
        if (skill.isInvisible() && chr.getSkillLevel(skill) == 0 && !(skillid == 11111008 || skillid == 12111007 || skillid == 13110009 || skillid == 14111010 || skillid == 15111011 || skillid == 23121008 || skillid == 5321006)) {
