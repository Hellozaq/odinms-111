...
public class MapleLifeFactory {
    ...
    public static MapleMonsterStats getMonsterStats(int mid) {
        ...
        if (stats == null) {
            ...
            stats.setHp(mid == 9300275 ? 5000 : mid == 9300438 ? 2000 : MapleDataTool.getIntConvert("maxHP", monsterInfoData));
            ...
            if (stats.getTagColor() > 0) {
                ...
                hpdisplaytype = 2;
            } else if (!stats.isBoss() || mid == 9410066 || stats.isPartyBonus() || (mid >= 9800000 && mid <= 9800124)) { // Not boss and dong dong chiang
                hpdisplaytype = 3;
            }
