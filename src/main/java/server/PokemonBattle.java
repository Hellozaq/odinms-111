...
public class PokemonBattle {
    ...
    public void initiate(MapleCharacter initiator, PokemonMap mapp) { //wild battle
        ...
        initiator.getClient().sendPacket(EtcPacket.musicChange(wildBGM));
    ...
    public void initiate(MapleCharacter initiator, MapleNPC npc) { //wild battle
        ...
        initiator.dropMessage(-6, "What will you do? @use @info @ball @run @battlehelp");
        turn[1] = makeRandomTurn();
        initiator.getClient().sendPacket(EtcPacket.musicChange(npcBGM));
        firstTurn(battlers[0], battlers[1]);
    }
    ...
    public void initiate() { //trainer battle
        ...
        map.broadcastMessage(EtcPacket.getChatText(initiator.getId(), "Go, " + battlers[0].getName() + "! (Level " + battlers[0].getLevel() + ")", initiator.isGM(), 0));
        map.broadcastMessage(EtcPacket.getChatText(initiator2.getId(), "Go, " + battlers[1].getName() + "! (Level " + battlers[1].getLevel() + ")", initiator2.isGM(), 0));
        ...
        initiator.getClient().sendPacket(EtcPacket.musicChange(trainerBGM));
        initiator2.getClient().sendPacket(EtcPacket.musicChange(trainerBGM));
        firstTurn(battlers[0], battlers[1]);
                    ...
                    EtcTimer.getInstance().schedule(new Runnable() {
                        ...
                        public void run() {
                            if (user != null && !disposed) {
                                user.getClient().sendPacket(EtcPacket.playSound("Cokeplay/Fall"));
                                catchEffect(battlers[1].getMonster());
                            } else {
                                dispose();
                            }
                    ...
                    EtcTimer.getInstance().schedule(new Runnable() {
                        ...
                        public void run() {
                            if (user != null && !disposed) {
                                ...
                                user.getClient().sendPacket(EtcPacket.playSound("Romio/discovery"));
                        ...
                        switch (turn[i]) {
                            ...
                            case SWITCH:
                                ...
                                if (battlers[i] != null) {
                                    ...
                                    map.broadcastMessage(EtcPacket.getChatText(characterIds[i], "Return, " + battlers[i].getName() + "!", false, 0));
                                ...
                                if (i == 1 && npcTeam != null) {
                                    ...
                                    map.broadcastMessage(EtcPacket.getChatText(characterIds[i], "Go, " + battlers[i].getName() + "! (Level " + battlers[i].getLevel() + ")", false, 0));
                                }
                            ...
                            case ATTACK:
                                ...
                                if (attacks[i] != null) {
                                    map.broadcastMessage(EtcPacket.getChatText(characterIds[i], battlers[i].getName() + ", use " + attacks[i] + "!", false, 0));
                                }
                                    ...
                                    public void run() {
                                        ...
                                        if (battlers[i == 1 ? 0 : 1].getCurrentHP() <= 0) {
                                                        ...
                                                        if (b != null && b.getMonsterId() == z) {
                                                            ...
                                                            if (b.getTrueLevel() > oLevel) {
                                                                ...
                                                                if (!b.getStats().getName().equals(oName)) {
                                                                    ch.getClient().sendPacket(EtcPacket.playSound("5th_Maple/prize"));
                                            ...
                                            if (instanceid >= 0 && i == 0 && npcTeam == null) {
                                                ...
                                                chr.getClient().sendPacket(EtcPacket.playSound("Romio/discovery"));
                                                dispose(chr, false);
                                                return;
                                            }
                                            if (instanceid >= 0 && i == 0 && npcTeam != null) {
