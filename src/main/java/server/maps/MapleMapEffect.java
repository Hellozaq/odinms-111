...
public class MapleMapEffect {
    ...
    public byte[] makeDestroyData() { //jukebox doesn't REALLY have a destroy, but 0 stops all music
        return jukebox ? MTSCSPacket.playCashSong(0, "") : EtcPacket.removeMapEffect();
    }

    public byte[] makeStartData() {
        return jukebox ? MTSCSPacket.playCashSong(itemId, msg) : EtcPacket.startMapEffect(msg, itemId, active);
    }
