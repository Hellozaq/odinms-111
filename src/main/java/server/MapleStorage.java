...
public class MapleStorage implements Serializable {
    ...
    public void sendStorage(MapleClient c, int npcId) {
        ...
        for (MapleInventoryType type : MapleInventoryType.values()) {
            typeItems.put(type, new ArrayList<Item>(items));
        }
        c.sendPacket(EtcPacket.NPCPacket.getStorage(npcId, slots, items, meso));
    }

    public void sendStored(MapleClient c, MapleInventoryType type) {
        c.sendPacket(EtcPacket.NPCPacket.storeStorage(slots, type, typeItems.get(type)));
    }

    public void sendTakenOut(MapleClient c, MapleInventoryType type) {
        c.sendPacket(EtcPacket.NPCPacket.takeOutStorage(slots, type, typeItems.get(type)));
    }
    ...
    public void sendMeso(MapleClient c) {
        c.sendPacket(EtcPacket.NPCPacket.mesoStorage(slots, meso));
    }
    ...
    public void arrangeStorage(MapleClient c) {
        ...
        c.sendPacket(EtcPacket.NPCPacket.arrangeStorage(slots, items));
        changed = true;
    }
}
