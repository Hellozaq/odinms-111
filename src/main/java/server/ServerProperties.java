...
public class ServerProperties {
    ...
    static {
        //loadProperties(GameConstants.GMS ? "config/worldGMS.properties" : "config/world.properties");
        //loadProperties("config/db.properties");
        //loadProperties("config/channel.properties");
        loadProperties(GameConstants.GMS ? "config.properties" : "config/world.properties");
        Connection con = null;
